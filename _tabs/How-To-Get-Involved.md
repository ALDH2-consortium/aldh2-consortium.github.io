...
**Necessary Data: Only maternal *ALDH2* genotype data is necessary, along with at least one phenotype below.** 
...
**Necessary data: *ALDH2* genotype on any cohort participants with infection data are required**. For example infectious diseases, please see below. However, please not that in secondary exploratory analyses, we will include a broad range of child and adult infectious diseases, so please do include all infectious disease data available in your cohort when completing the expression of interest form, thank you very much!
